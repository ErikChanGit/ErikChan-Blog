...
![image-20210312110838150](figures/cubemx_1.png)
...
![image-20210312110932425](figures/cubemx_3.png)
...
到此所有信息都填写完成了，可以点击右上角`预览`按钮，检查开发板信息是否填写无误。检查没有问题后可点击`生成`按钮即可生成开发板资源包
